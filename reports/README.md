...
- `solver_economics_gas_aware.md`: per-pool break-even gas prices and net-of-gas payouts by venue scenario, from measured fill gas (regenerate with `python3 -m script.build_gas_aware_solver_economics`).
